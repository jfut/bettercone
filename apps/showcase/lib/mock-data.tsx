...
// Mock admin users for UserManagementTable
export const mockAdminUsers = [
  ...
  },
  {
    ...
    name: "Spam Account",
    image: "https://api.dicebear.com/7.x/avataaars/svg?seed=Spam",
    emailVerified: false,
  ...
  {
    id: "user_admin_008",
    email: "temp.ban@example.com",
    name: "Temp Banned",
    image: "https://api.dicebear.com/7.x/avataaars/svg?seed=Temp",
    emailVerified: true,
    createdAt: new Date("2024-03-01"),
    role: "user",
    banned: true,
    banReason: "Violation of terms (7 days)",
    banExpires: new Date(Date.now() + 5 * 24 * 60 * 60 * 1000), // 5 days from now
  },
  {
    id: "user_admin_009",
