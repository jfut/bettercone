...
// Optional dependency - install @wojtekmaj/react-recaptcha-v3 if needed
// import {
...
export function RecaptchaV3({ children }: { children: ReactNode }) {
    ...
    if (typeof GoogleReCaptchaProvider === 'undefined') {
        console.warn('Google reCAPTCHA v3 is not available. Please install @wojtekmaj/react-recaptcha-v3')
        return children
    }
...
function RecaptchaV3Style() {
    ...
    // Check if optional dependency is available
    if (typeof useGoogleReCaptcha === 'undefined') {
        return null
    }
