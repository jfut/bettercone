...
**Passkeys, Organizations & Account Management** - 6 new production-ready components

- **PasskeySetupWizard** - 5-step passkey registration wizard with platform/cross-platform selection
- **ChangeEmailCard** - Two-step email change with verification code
- **TransferOwnershipDialog** - Organization ownership transfer with role management
- **LinkAccountCard** - Link OAuth providers to existing accounts
- **UnlinkAccountCard** - Unlink OAuth providers with confirmation dialog
...
### v0.3.0 - Better Auth Stripe Plugin

**Stripe Billing Integration** - Full Stripe plugin support for Better Auth
