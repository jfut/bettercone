...
## 🎉 What's New in v0.4.0 - **API Key Management Enhancements**
...
<Cards>
  <Card
    ...
    description="Extend Better Auth with additional functionality and custom plugins"
    href="/docs/plugins"
  />
  <Card
...
**Total: 85 components covering 100% of Better Auth core functionality!**
