...
- [**Usage Tracking Plugin**](/docs/plugins/usage-tracking) - Track API usage, enforce limits, and manage feature access (separate package: `@bettercone/better-auth-plugin-usage-tracking`)
...
<Cards>
  <Card
    ...
    description="Usage tracking, rate limiting, and more - extend Better Auth functionality"
    href="/docs/plugins"
  />
  <Card
    title="🏢 Enterprise SSO"
    description="OIDC & SAML 2.0 SSO configuration, SAML setup wizard, OAuth2 provider management"
    href="/docs/components/enterprise"
  />
  <Card
  ...
  <Card
    ...
    description="2FA, passkeys, sessions, password management, OAuth providers"
