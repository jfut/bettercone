...
<Callout type="warn" title="Plugin Required">
  This component requires the `@bettercone/better-auth-plugin-usage-tracking` plugin to be installed and configured in your Better Auth setup. See [Plugin Installation](#plugin-installation) below.
</Callout>
