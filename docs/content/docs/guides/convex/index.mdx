---
title: Database
description: Using Convex with @bettercone/ui - real-time data storage for authentication and subscription features
---

import { Card, Cards } from 'fumadocs-ui/components/card';

@bettercone/ui works seamlessly with [Convex](https://convex.dev) for real-time, type-safe data storage with built-in authentication and subscription management.
...
├── schema.ts              # Tables: subscriptions, apiRateLimit, featureAccess
